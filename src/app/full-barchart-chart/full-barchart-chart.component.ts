...
var vis
@Component({
  selector: 'app-full-barchart-chart',
  templateUrl: './full-barchart-chart.component.html',
  styleUrls: ['./full-barchart-chart.component.css']
})
export class FullBarchartChartComponent implements OnInit {

  parentElement
  variable 
  title 
  constructor(_parentElement: string, _variable : string, _title: string) { 
  ...
  initVis = function(){
   vis = this;
    ...
    vis.yAxisCall = d3.axisLeft(vis.x)
        .ticks(4);
    vis.xAxisCall = d3.axisBottom(vis.y)
