...
var color
@Component({
  selector: 'app-full-timeline-chart',
  templateUrl: './full-timeline-chart.component.html',
  styleUrls: ['./full-timeline-chart.component.css']
})
export class FullTimelineChartComponent implements OnInit {
